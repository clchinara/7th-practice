...
A lightweight practice driller for 7th chords and their inversions: https://clchinara.github.io/7th-practice/. 
...
- Use this mode to learn and reinforce 7th chords by sight
- Focus on recognizing chord quality, inversion, and spacing at a glance

### 2. Active recall mode (*Reveal chord later* ON)
- Only the chord symbol and inversion are shown at first
- Use the interval to:
  - find the chord tones mentally
  - play the chord on your instrument
  - visualize the staff notation
- The diagram is revealed after the interval to check your answer
...
- Alternate between both modes in one session
